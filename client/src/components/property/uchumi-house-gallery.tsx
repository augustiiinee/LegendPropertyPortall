    ...
    <div className="relative bg-white rounded-lg border border-gray-200 shadow-sm">
      ...
      <div className="p-4">
        <div className="relative mb-6 group">
          ...
          {/* Main Image - Updated to 9:16 aspect ratio */}
        ...
        {property.images && property.images.length > 1 && (
          <div className="flex space-x-2 mb-4 overflow-x-auto pb-2">
            {property.images.map((image, index) => (
              <div 
                key={index}
                className={`cursor-pointer transition-all duration-200 ${currentImageIndex === index ? 'ring-2 ring-red-600' : 'opacity-70 hover:opacity-100'}`}
