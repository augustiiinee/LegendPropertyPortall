    ...
    `}>
      ...
      <div className="p-5">
        ...
        <div className="mt-3 pt-3 border-t border-gray-100">
          <h4 className="text-lg font-medium text-gray-700">Property Manager</h4>
          <div className="mt-2 bg-gray-50 rounded-lg p-3 flex items-center">
            ...
            <div className="flex-1">
              <h5 className="font-semibold text-sm">Legend Management Ltd</h5>
              <p className="text-xs text-gray-500">Property Manager</p>
              <div className="mt-2 flex space-x-2">
                <a href="tel:+254791181166" className="text-xs text-blue-600 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  </svg>
                  Call
                </a>
                <a href="mailto:joseph@propertylegend.com" className="text-xs text-blue-600 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1" viewBox="0 0 20 20" fill="currentColor">
                ...
                <a href="https://wa.me/254746369798" className="text-xs text-green-600 flex items-center">
