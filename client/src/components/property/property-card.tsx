  ...
  return (
    ...
    `}>
      ...
      <div className="p-5">
        ...
        {/* Property Manager Card - Exact Design */}
        <div className="mt-4 pt-4 border-t border-gray-200">
          <h4 className="text-xl font-medium text-gray-700">Property Manager</h4>
          <div className="mt-2 bg-white rounded-lg p-4 border border-gray-100 shadow-sm">
            <div className="flex items-start">
              <div className="w-16 h-16 rounded-full overflow-hidden mr-4 flex-shrink-0">
                <img src="/images/logo.png" alt="Legend Management Ltd" className="w-full h-full object-cover" />
              </div>
              <div className="flex-1">
                <h5 className="font-semibold text-lg text-gray-800">Legend Management Ltd</h5>
                <p className="text-sm text-blue-500">Property Manager</p>
                
                <div className="mt-4 flex flex-wrap gap-2">
                  <a href="tel:+254791181166" className="inline-flex items-center justify-center px-4 py-2 bg-white border border-gray-200 rounded-md text-gray-700 text-sm font-medium shadow-sm hover:bg-gray-50">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
                      <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                    </svg>
                    Call
                  </a>
                  <a href="mailto:joseph@propertylegend.com" className="inline-flex items-center justify-center px-4 py-2 bg-white border border-gray-200 rounded-md text-gray-700 text-sm font-medium shadow-sm hover:bg-gray-50">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <a href="https://wa.me/254746369798" className="inline-flex items-center justify-center px-4 py-2 bg-green-500 rounded-md text-white text-sm font-medium shadow-sm hover:bg-green-600">
