              ...
              <div className="mt-6 space-y-3">
                <div className="flex space-x-2">
                  ...
                  <button 
                    onClick={() => {
                      // Try to extract phone number from the description
                      let phoneNumber = '254740445986'; // Utalii house contact
                      if (property.description.includes('Tel:')) {
                        const telLine = property.description.split('Tel:')[1].split('\n')[0].trim();
                        if (telLine) {
                          // Extract just the digits
                ...
                <div className="mt-4 text-sm text-gray-600">
                  <p className="mb-2">📞 To Arrange a Viewing or Get More Details:</p>
                  <p className="font-semibold mb-0.5">Legend Management Ltd.</p>
                  <p className="mb-0.5">Tel: 0740445986 | 0729600465</p>
                  <p className="mb-0.5">Email: raymond@propertylegend.com | kenneth@propertylegend.com</p>
                  <p className="mb-0.5">Address: Utalii House Ground floor, Utalii Street, CBD, Nairobi.</p>
                </div>
              </div>
            </div>
