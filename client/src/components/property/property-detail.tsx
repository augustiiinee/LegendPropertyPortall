  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white rounded-lg shadow-md p-4 md:p-8">
        ...
        {/* Property Manager Information - Exact Design */}
        <div className="mb-8">
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-100 shadow-sm">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-xl text-gray-800">Legend Management Ltd</h3>
                <p className="text-md text-blue-500">Property Manager</p>
                
                <div className="mt-5 flex flex-wrap gap-3">
                  <a href="tel:+254791181166" className="inline-flex items-center justify-center px-5 py-2 bg-white border border-gray-200 rounded-md text-gray-700 font-medium shadow-sm hover:bg-gray-50">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                      <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                    </svg>
                    Call
                  </a>
                  <a href="mailto:joseph@propertylegend.com" className="inline-flex items-center justify-center px-5 py-2 bg-white border border-gray-200 rounded-md text-gray-700 font-medium shadow-sm hover:bg-gray-50">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <a href="https://wa.me/254746369798" className="inline-flex items-center justify-center px-5 py-2 bg-green-500 rounded-md text-white font-medium shadow-sm hover:bg-green-600">
