  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white rounded-lg shadow-md p-4 md:p-8">
        ...
        {/* Agent Information */}
        <div className="mb-8">
          <h2 className="text-xl md:text-2xl font-semibold mb-4">Property Agent</h2>
          <AgentCard 
            agent={{
              id: 1,
              name: "Jane Doe",
              ...
              phone: "+254712345678",
              email: "jane.doe@legendmanagement.com"
            }}
          />
        </div>
        ...
        <div className="bg-neutral-lightest p-6 rounded-lg">
          ...
          <div className="flex flex-wrap gap-4">
            <Button 
              ...
              onClick={() => window.open(`tel:+254712345678`, '_blank')} 
            >
            ...
            <Button 
              ...
              onClick={() => window.open(`mailto:info@legendmanagement.com?subject=Inquiry about ${property.title}`, '_blank')}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
            ...
            <Button 
              ...
              onClick={() => window.open(`https://wa.me/254746369798?text=I'm interested in ${property.title}`, '_blank')}
            >
