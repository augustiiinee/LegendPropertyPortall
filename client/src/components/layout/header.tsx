          ...
          <div className="flex flex-wrap justify-between text-xs md:text-sm">
            <div className="flex items-center space-x-4">
              <div className="flex items-center">
                <MapPin className="h-3.5 w-3.5 mr-1 text-gold" />
                <span className="text-gray-700">NHIF Building, 3rd floor, Upperhill</span>
              </div>
              <div className="hidden md:flex items-center">
                <Phone className="h-3.5 w-3.5 mr-1 text-gold" />
                <span className="text-gray-700">+254 020-2713445/6</span>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="flex items-center">
                <Mail className="h-3.5 w-3.5 mr-1 text-gold" />
                <a href="mailto:info@propertylegend.com" className="text-gray-700 hover:text-gold transition-colors">
            ...
            <nav className="hidden md:flex space-x-1">
              {navigation.map((item) => (
                <Link 
                  key={item.name} 
                  href={item.path}
                  className={`font-montserrat font-medium py-2 px-4 ${
              ...
              {user && (
                <div className="flex items-center space-x-4">
                  <Link 
                    href="/admin"
                    className="font-montserrat font-medium text-primary hover:text-gold transition"
                  >
                    Admin
                  </Link>
                  <Button 
