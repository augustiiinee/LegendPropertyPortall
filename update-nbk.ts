...
`,
        ...
        // Add the commercial category image at the beginning of the images array
        images: [
          '/images/categories/commercial-bg.jpg',
          ...(nbkProperty.images || []).filter(img => img !== '/images/categories/commercial-bg.jpg')
        ],
        featured: true,
      })
    ...
    console.log("Updated National Bank of Kenya property:", updated);
  } catch (error) {
    console.error("Error updating National Bank of Kenya property:", error);
  }
}
